...
pub struct NetworkQuicExecutor<OT, S, SP>
...
pub struct NetworkQuicExecutorBuilder<'a,SP>
where SP: ShMemProvider,
{
...
// impl NetworkQuicExecutor<(), (), UnixShMemProvider> {
//     /// Builder for `NetworkQuicExecutor`
//     #[must_use]
//     pub fn builder() -> NetworkQuicExecutorBuilder<'static, UnixShMemProvider> {
//         NetworkQuicExecutorBuilder::new()
//     }
// }

impl<OT, S,SP> NetworkQuicExecutor<OT, S,SP> 
where 
OT: ObserversTuple<S>,
S: State, 
SP: ShMemProvider,
...
impl<OT, S,SP> UsesState for NetworkQuicExecutor<OT, S, SP>
where
    S: State, 
    SP: ShMemProvider
{
...
impl<OT, S,SP> UsesObservers for NetworkQuicExecutor<OT, S,SP>
where
    OT: ObserversTuple<S>,
    S: State,
    SP: ShMemProvider
...
impl<OT, S,SP> HasObservers for NetworkQuicExecutor<OT, S,SP>
where
    S: State,
    OT: ObserversTuple<S>,
    SP: ShMemProvider
...
impl<EM, OT, S,SP, Z> Executor<EM, Z> for NetworkQuicExecutor<OT, S,SP>
where
